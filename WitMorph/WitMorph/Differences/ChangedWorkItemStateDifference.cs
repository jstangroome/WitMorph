...
{
    public class ChangedWorkItemStateDifference : IWorkItemTypeDifference
    {
        ...
        public ChangedWorkItemStateDifference(string currentWorkItemTypeName, string currentStateName, WitdState goalState)
        {
