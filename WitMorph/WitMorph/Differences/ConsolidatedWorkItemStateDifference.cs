...
{
    public class ConsolidatedWorkItemStateDifference : IWorkItemTypeDifference
    {
        ...
        public ConsolidatedWorkItemStateDifference(string currentWorkItemTypeName, string currentStateName, WitdState goalState)
        {
